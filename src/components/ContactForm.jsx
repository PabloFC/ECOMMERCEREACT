    ...
    <div className="container">
      <div className="row">
        <div className="col-12 col-md-10 col-lg-8">
          <h6 className="fs-5 mb-2 text-secondary text-uppercase text-start">Contact</h6>
          <h5 className="display-5 mb-4 mb-md-5 mb-xl-8 text-start">
            We are always on the lookout to work with new clients. Please get in
          ...
          <div className="row justify-content-xl-center">
            <div className="col-12 col-xl-11">
              <div className="mb-4 mb-md-5">
                ...
                <div>
                  <h4 className="mb-2 text-start">Office</h4>
              ...
              <div className="row mb-sm-4 mb-md-5">
                <div className="col-12 col-sm-6">
                  <div className="mb-4 mb-sm-0">
                    ...
                    <div>
                      <h4 className="mb-2 text-start">Phone</h4>
                ...
                <div className="col-12 col-sm-6">
                  <div className="mb-4 mb-sm-0">
                    ...
                    <div>
                      <h4 className="mb-2 text-start">Email</h4>
              ...
              <div>
                ...
                <div>
                  <h4 className="mb-2 text-start">Opening Hours</h4>
